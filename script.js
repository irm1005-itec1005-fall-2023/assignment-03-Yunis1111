...
addToDoItem("This is a todo item");
...
clearCompletedTasks(); // This should remove the completed todo item from the array
  console.log(todoItems); // This should show an empty array